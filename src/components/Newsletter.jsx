...
const Newsletter = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto text-center pb-16 pt-8">
            <h2 className="text-3xl text-yellow-500 font-bold">Subcribe To Our Newsletter</h2>
            ...
            <form onSubmit={handleSubscribe}>
                <input className="w-96 h-12 mt-4 rounded-tl-md rounded-bl-md bg-white text-black font-medium px-4 outline-none" type="email" name="email" placeholder="Your Email" required />
