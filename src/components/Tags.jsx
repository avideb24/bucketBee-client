    ...
    return (
      ...
      <div className="flex flex-wrap justify-center items-center gap-5">
        {uniqueCategories.map((category) => (
          <div key={category} className="text-center hover:text-[#363636] border-2 border-[#539aa0]  bg-transparent text-[#539aa0] hover:-rotate-180 hover:bg-[#539aa0] px-5 py-3 rounded-full font-bold duration-200">
            {category}
          </div>
        ))}
      </div>
